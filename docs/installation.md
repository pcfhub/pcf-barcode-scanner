...
No dependency beyond the platform's own device APIs — nothing to install
first. Scanning needs a device with a camera or barcode-scanner hardware;
without one, the field still works as a plain text box (see
